...
To Run File:
dropdb -d codeclanzo_manager 
createdb -d codeclanzo_manager
psql -codeclanzo_manager -f codeclanzo_manager.sql
python3 console.py (optional to populate DB with a user and a transaction)
flask run (click IP address for homepage)
